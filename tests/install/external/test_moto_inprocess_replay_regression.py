...
@pytest.mark.xfail(
    strict=True,
    reason="Retrace _random.Random patching breaks moto's MotoRandom subclass during record",
)
...
@pytest.mark.xfail(
    strict=True,
    reason="in-process moto mock_aws currently fails during Retrace record before replay",
)
