...
namespace retracesoftware {
    ...
    struct WrappedMember : public Wrapped {
        ...
        static PyObject* tp_descr_get(WrappedMember * self, PyObject * instance, PyObject * type) {
            PyObject * getter = PyObject_GetAttrString(reinterpret_cast<PyObject *>(Py_TYPE(self->target)), "__get__");
        ...
        static int tp_descr_set(WrappedMember *self, PyObject *instance, PyObject *value) {
            if (value) {
                PyObject * setter = PyObject_GetAttrString(reinterpret_cast<PyObject *>(Py_TYPE(self->target)), "__set__");
                if (!setter) return -1;
                ...
                PyObject * deleter = PyObject_GetAttrString(reinterpret_cast<PyObject *>(Py_TYPE(self->target)), "__delete__");
                if (!deleter) return -1;
